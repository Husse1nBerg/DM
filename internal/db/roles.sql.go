...
VALUES ($1, $2, $3, $4)
RETURNING id, name, description, permissions, is_active, created_at, updated_at, deleted_at
`
...
SELECT id, name, description, permissions, is_active, created_at, updated_at, deleted_at
FROM roles
